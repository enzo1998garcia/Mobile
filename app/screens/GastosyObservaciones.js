...
const GastosyObservaciones = () => {
  ...
  const handleAgregarGasto = async () => {
    ...
    try {
      ...
      const response = await fetch('http://107.22.75.115:4000/api/gastos/iniciarRegistroGastos', {
        method: 'POST',
        headers: {
  ...
  const handleModificarGasto = async () => {
    ...
    try {
      ...
      const response = await fetch('http://107.22.75.115:4000/api/gastos/modificarGastos', {
        method: 'POST',
        headers: {
          Accept: 'application/json',
  ...
  const handleEliminarGasto = async (gastoId,index) => {
    try {
      const response = await fetch('http://107.22.75.115:4000/api/gastos/EliminarGastos', {
        method: 'POST',
        headers: {
          Accept: 'application/json',
          'Content-Type': 'application/json',
